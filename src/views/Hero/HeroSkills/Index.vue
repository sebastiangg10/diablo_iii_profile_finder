<template>
  <div class="skills-wrapper mt-5">
    ...
    <b-nav pills small>
      ...
      @click="changeComponent('ActiveSkills')">Active</b-nav-item>
      <b-nav-item :active="isPassiveSkillsActive"
      @click="changeComponent('PassiveSkills')">Passive</b-nav-item>
    </b-nav>

    <keep-alive>
      <component :is="activeComponent" :skills="componentProps"></component>
    </keep-alive>
  </div>
</template>
